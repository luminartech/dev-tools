...
def test__load_devcontainer_config__loads_extensions(fs: FakeFilesystem, simple_devcontainer_json: str) -> None:  # noqa: ARG001
...
def test__load_devcontainer_config__loads_settings(fs: FakeFilesystem, simple_devcontainer_json: str) -> None:  # noqa: ARG001
    devcontainer_json_path = Path("devcontainer.json")
    devcontainer_json_path.write_text(simple_devcontainer_json)
    read_config = load_devcontainer_config(devcontainer_json_path)
...
def test__update_vscode_settings_json__creates_new_settings(fs: FakeFilesystem) -> None:  # noqa: ARG001
...
def test__update_vscode_settings_json__updates_existing_settings(fs: FakeFilesystem) -> None:  # noqa: ARG001
    settings_json_path = Path("settings.json")
...
def test__update_vscode_settings_json__leaves_custom_settings(fs: FakeFilesystem) -> None:  # noqa: ARG001
    settings_json_path = Path("settings.json")
...
def test__update_vscode_settings_json__formats_the_json(fs: FakeFilesystem) -> None:  # noqa: ARG001
    settings_json_path = Path("settings.json")
...
def test__update_vscode_settings_json__adds_newline_at_the_end(fs: FakeFilesystem) -> None:  # noqa: ARG001
    settings_json_path = Path("settings.json")
...
def test__update_vscode_extensions_json__creates_new_recommendations(fs: FakeFilesystem) -> None:  # noqa: ARG001
    extensions_json_path = Path("extensions.json")
...
def test__update_vscode_extensions_json__adds_new_recommendations(fs: FakeFilesystem) -> None:  # noqa: ARG001
    extensions_json_path = Path("extensions.json")
...
def test__update_vscode_extensions_json__makes_recommendations_unique(fs: FakeFilesystem) -> None:  # noqa: ARG001
    extensions_json_path = Path("extensions.json")
    extensions_json_path.write_text('{"recommendations":["charliermarsh.ruff"]}')
...
def test__update_vscode_extensions_json__supports_utf8_chars(fs: FakeFilesystem) -> None:  # noqa: ARG001
    extensions_json_path = Path("extensions.json")
...
def test__update_vscode_extensions_json__adds_newline_at_the_end(fs: FakeFilesystem) -> None:  # noqa: ARG001
    extensions_json_path = Path("extensions.json")
    update_vscode_extensions_json(extensions_json_path, ["ms-python.python"])
...
def test__update_vscode_extensions_json__creates_vscode_folder(fs: FakeFilesystem) -> None:  # noqa: ARG001
    extensions_json_path = Path("a_vscode_folder", "extensions.json")
    update_vscode_extensions_json(extensions_json_path, ["ms-python.python"])
    assert Path("a_vscode_folder").is_dir()
